...
const Book = ({ width, height, onClick }: IconProps) => (
  <svg width={width} height={height} viewBox="0 -960 960 960" fill="#1f1f1f" xmlns="http://www.w3.org/2000/svg" onClick={onClick}>
