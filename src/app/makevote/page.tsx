...
const MakeVote = () =>{
    ...
    return (
        <MakeVoteLayout>
            ...
            <Button onCkick={() => router.push(`${path}/detail`)} text="투표 제작하기" icon={<Plus width="100%" height="100%" />}/>
            </MakeVoteActiveSection>

            </MakeVoteSection>

            {isOpen_1 && <TwoOptionModal title="투표 제작을 그만 두시겠습니까?" info="지금까지 작성한 내용은 저장되지 않습니다." isOpen={isOpen_1} setIsOpen={setIsOepn_1} passfunction={CanCelMakeVote} />}
        </MakeVoteLayout>
    )
}
