                ...
                <ReportBallotBox>
                    <ReportReasonTopBox>
                        <ReportReasonChoiceText>
                            신고 사유 선택 <ReportReasonChoiceAccentText>*</ReportReasonChoiceAccentText>
                        </ReportReasonChoiceText>
                        ...
                        {ReportReason.map((ballot) => (
                            <Ballot
                                ...
                                type="report"
                                onClick={() =>
                                    setSelectedOption((prev) => (prev === ballot.id ? null : ballot.id))
                                }
                            />
                        ))}
                    </ReportReasonTopBox>
                    ...
                    <ReportReasonBottomBox>
                        <ReportReasonChoiceText>
                            상세 내용 <ReportReasonChoiceAccentText>*</ReportReasonChoiceAccentText>
                        </ReportReasonChoiceText>
