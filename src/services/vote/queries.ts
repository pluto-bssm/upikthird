...
export const AIOPTION_CREATE = `query MyQuery($count: Int!, $title: String!) { optionGenerator { generateOptions(count: $count, title: $title) { message options success } } aiQuota { canUseAI getMyQuota { maxUsageCount remainingCount usageCount canUseNow } } }`;
